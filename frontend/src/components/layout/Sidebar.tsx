...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: "rl-trading", labelKey: "nav.rl_trading", icon: Bot, shortcut: "" },
...
export default function Sidebar() {
  ...
  const sidebarContent = (
    <div className="flex flex-col h-full oracle-sidebar">
      ...
      {/* Portal link */}
      <div className="border-t border-oracle-border mt-auto pt-4 px-2 pb-4">
        <a
          href="https://portal.darc3.com"
          className={`flex items-center gap-3 rounded-md text-sm text-oracle-muted hover:text-oracle-text hover:bg-oracle-panel-hover transition-colors ${
            sidebarCollapsed ? "justify-center px-2 py-3" : "px-3 py-2.5"
          }`}
        >
          ...
          {!sidebarCollapsed && <span>Portal</span>}
        </a>
      </div>
